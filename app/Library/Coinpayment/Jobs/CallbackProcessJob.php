...
namespace App\Library\Coinpayment\Jobs;
...
class CallbackProcessJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        */
        ...
        if ($this->data['request_type'] === 'schedule_transaction') {
            $this->completeTransaction($this->data['txn_id']);
        } elseif ($this->data['request_type'] === 'create_transaction') {
            $this->completeTransaction($this->data['transaction']['txn_id']);
        }
    }
}
