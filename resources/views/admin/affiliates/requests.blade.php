...
<div class="container Josefins">
    <form action="{{route('admin.affiliate.requests.manage_list')}}" method="post" id="manageList" onsubmit="return false;">
        <input name="action" value="" type="hidden">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="pull-left no-margin">Affiliate Requests</h2>
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>{{$affiliate->message}}</td>
                        <td>{{$affiliate->forwarded_to}}</td>
